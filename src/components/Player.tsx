...
// Typescript xətası verməməsi üçün
...
export function Player() {
  ...
  // URL-in düzgünlüyünü təmin edirik
  const playerUrl = currentTrack.videoUrl || `ytsearch:${currentTrack.artist} ${currentTrack.title} audio`;
        ...
        <div className="flex items-center gap-3 w-1/3 min-w-0">
          ...
          <div className="relative group shrink-0 h-14 w-24 sm:h-16 sm:w-28 bg-black rounded-md overflow-hidden border border-white/10 shadow-lg">
            ...
            <ReactPlayerCast
              ref={playerRef}
              url={playerUrl}
              playing={isPlaying} // Burası TRUE olmalıdır ki oxusun
              volume={volume}
              muted={false}
              width="100%"
              height="100%"
