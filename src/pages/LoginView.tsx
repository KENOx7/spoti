...
export default function LoginView() {
  ...
  const handleSocialLogin = async (provider: "google" | "spotify") => {
    try {
      ...
      // Spotify üçün bütün lazım olan icazələr
      const scopes = provider === 'spotify' 
        ? 'user-read-email user-read-private playlist-read-private playlist-read-collaborative user-library-read streaming'
        : undefined;
      ...
      const { error } = await supabase.auth.signInWithOAuth({
        ...
        options: {
          ...
          scopes: scopes, // İcazələri göndəririk
        },
      });
